...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    void onExportInfoClicked() {
        if (this.amiiboManager == null) {
            showToast(getString(R.string.error_amiibo_info_not_loaded), Toast.LENGTH_SHORT);
            return;
        }
        ...
        try {
            ...
            e.printStackTrace();
            showToast(getString(R.string.error_export_failed) + Util.friendlyPath(file), Toast.LENGTH_SHORT);
            return;
        } finally {
        ...
        showSnackbar(getString(R.string.exported_amiibo_info) + Util.friendlyPath(file), Snackbar.LENGTH_LONG);
    }
    ...
    void onGameSeriesStatsClicked() {
        ...
        new AlertDialog.Builder(this.getContext())
            .setTitle(R.string.title_game_series)
    ...
    void onCharacterStatsClicked() {
        ...
        new AlertDialog.Builder(this.getContext())
            .setTitle(R.string.title_characters)
    ...
    void onAmiiboSeriesStatsClicked() {
        ...
        new AlertDialog.Builder(this.getContext())
            .setTitle(R.string.title_amiibo_series)
            .setAdapter(new ArrayAdapter<>(this.getContext(), android.R.layout.simple_list_item_1, items), null)
            .setPositiveButton(getString(R.string.button_close), null)
            .show();
    }
    ...
    void onAmiiboTypesStatsClicked() {
        ...
        new AlertDialog.Builder(this.getContext())
            .setTitle(R.string.title_amiibo_types)
            .setAdapter(new ArrayAdapter<>(this.getContext(), android.R.layout.simple_list_item_1, items), null)
            .setPositiveButton(getString(R.string.button_close), null)
            .show();
    }
    ...
    void loadAmiiboManagerTask() {
        ...
        try {
            ...
            e.printStackTrace();
            showToast(getString(R.string.error_failed_to_load_info), Toast.LENGTH_SHORT);
            return;
        }
        if (Thread.currentThread().isInterrupted())
            return;
    ...
    void updateAmiiboManagerTask(Uri data) {
        ...
        try {
            ...
            e.printStackTrace();
            showToast(getString(R.string.error_failed_to_parse_info), Toast.LENGTH_SHORT);
            return;
        } catch (IOException e) {
            e.printStackTrace();
            showToast(getString(R.string.error_failed_to_read_info), Toast.LENGTH_SHORT);
            return;
        }
        if (Thread.currentThread().isInterrupted())
            return;
        ...
        try {
            ...
            e.printStackTrace();
            showToast(getString(R.string.error_failed_to_update_info), Toast.LENGTH_SHORT);
            return;
        }
        if (Thread.currentThread().isInterrupted())
            return;
        ...
        setAmiiboManager(amiiboManager);
        showSnackbar(getString(R.string.updated_amiibo_info), Snackbar.LENGTH_SHORT);
    }
    ...
    void resetAmiiboManagerTask() {
        ...
        try {
            ...
            e.printStackTrace();
            showToast(getString(R.string.error_failed_to_parse_default_info), Snackbar.LENGTH_SHORT);
        }
        if (Thread.currentThread().isInterrupted())
            return;
    ...
    void updateAmiiboStats() {
        ...
        this.amiiboStats.setSummary(getString(R.string.stats_total) + amiiboCount);
        this.gameSeriesStats.setSummary(getString(R.string.stats_total) + gameSeriesCount);
        this.characterStats.setSummary(getString(R.string.stats_total) + characterCount);
        this.amiiboSeriesStats.setSummary(getString(R.string.stats_total) + amiiboSeriesCount);
        this.amiiboTypeStats.setSummary(getString(R.string.stats_total) + amiiboTypeCount);
    }
    ...
    void downloadAmiiboAPIDataTask() {
        showSnackbar(getString(R.string.syncing_info_amiiboapi), Snackbar.LENGTH_INDEFINITE);
        try {
            ...
            if (statusCode == 200) {
                ...
                Util.saveLocalAmiiboInfo(this.getContext(), amiiboManager);
                setAmiiboManager(amiiboManager);
                showSnackbar(getString(R.string.syncing_info_success), Snackbar.LENGTH_SHORT);
            } else {
            ...
            if (Thread.currentThread().isInterrupted())
                return;
            showSnackbar(getString(R.string.syncing_info_failure), Snackbar.LENGTH_SHORT);
        }
    }
